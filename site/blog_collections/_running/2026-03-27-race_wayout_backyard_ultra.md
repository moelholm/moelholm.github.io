...
race_website: "https://www.sportstiming.dk/event/16176"
---

Back at it for the third time! `Wayout Backyard Ultra 2026` — a backyard ultra trail race at Fort Østerlund in Silkeborg. This year I completed **21 loops** (yards) covering {{ page.distance_km }} kilometers over 21 hours. And yes — a new PB 🎉!

{% capture rows %}
Race|Wayout Backyard Ultra 2026;
Date|{{ page.race_date }};
...
|------------|------------|
| <!-- strava-summary-1 --> | <!-- strava-summary-2 --> |
{% endcapture %}
...
<!-- PHOTO PLACEHOLDER: Race area with afternoon daylight / Fort Østerlund exterior (2 photos) -->
{% capture table_content %}
|------------|------------|
| <!-- race-area-1 --> | <!-- race-area-2 --> |
{% endcapture %}
...
<!-- PHOTO PLACEHOLDER: Inside the shared tent (2 photos) -->
{% capture table_content %}
|------------|------------|
| <!-- tent-inside-1 --> | <!-- tent-inside-2 --> |
{% endcapture %}
...
<!-- PHOTO PLACEHOLDER: Mads and me + Mads' tent (2 photos) -->
{% capture table_content %}
|------------|------------|
| <!-- mads-1 --> | <!-- mads-tent --> |
{% endcapture %}
...
{% capture table_content %}
|------------|------------|
| <!-- daylight-running-1 --> | <!-- daylight-running-2 --> |
{% endcapture %}
...
{% capture table_content %}
|------------|------------|
| <!-- photographer-shot-1 --> | <!-- photographer-shot-2 --> |
{% endcapture %}
